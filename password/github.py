...
def datei(websiteName, username, password, mode):
    s1 = '\n' + 'Site:' + websiteName + '\n'
    s2 = 'User id:' + username + '\n'
    s3 = 'Password:' + password + '\n'
    # Writing the credentials to a text file.
    with open("yunuspw.txt", mode) as file:
        file.write(s1 + s2 + s3)
...
def enycrpt(key, case):
    ...
    with open("yunuspw.txt", "w") as file:
    ...
    if userChoice == 'new':
        ...
        while True:
            ...
            if readyOrNot.lower() == "ready":
                ...
                # writing the data
                datei(websiteName, username, password, 'w')
        ...
        if manageOrStore == '1':
            ...
            while True:
                ...
                if readyOrNot.lower() == "ready":
                    ...
                    datei(websiteName, username, password, 'a')
